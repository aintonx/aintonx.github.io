...
export const ZONES = [
  ...
  /* Разделы «Архитектор» и «Поддержка» слиты в один: текст был одним
     рассказом, разрезанным границей секций. Зона теперь одна, снимает
     весь раздел вместе с панелью усиления. */
  { id: 'architect',     имя: 'Архитектор и антенна',    sel: '#architect' },
